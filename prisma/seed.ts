...
async function main() {
  ...
  // create cargo
  const air3c1 = await prisma.cargo.create({
    data: {
      name: 'Water Container (5 Gallon)',
      fs: 358,
      weight: 40,
      aircraft: { connect: { id: 3 } },
    },
  })

  const air3c2 = await prisma.cargo.create({
    data: {
      name: 'Std 2 gal liquid container',
      weight: 25,
      fs: 260,
  ...
  const air3c3 = await prisma.cargo.create({
    data: {
      name: 'Hot Cup',
      fs: 260,
      weight: 3,
  ...
  const air3c4 = await prisma.cargo.create({
    data: {
      name: 'Human Waste Clean-up kit',
      fs: 280,
      weight: 5,
  ...
  const air3c5 = await prisma.cargo.create({
    data: {
      name: 'Blanket Large',
      fs: 280,
      weight: 3.5,
  ...
  const air3c6 = await prisma.cargo.create({
    data: {
      name: 'Pillow Large w/Case',
      fs: 280,
      weight: 2,
  ...
  const air3c7 = await prisma.cargo.create({
    data: {
      name: 'Blanket Small',
      fs: -1,
      weight: 1,
  ...
  const air3c8 = await prisma.cargo.create({
    data: {
      name: 'Pillow Small w/Case',
      fs: -1,
      weight: 0.5,
  ...
  const air3c9 = await prisma.cargo.create({
    data: {
      name: 'Expendable Supplies',
      fs: 260,
      weight: 10,
  ...
  const air3c10 = await prisma.cargo.create({
    data: {
      name: 'Passenger Demo Kit',
      fs: 380,
      weight: 3,
  ...
  const air3c11 = await prisma.cargo.create({
    data: {
      name: 'Pax info cards (102)',
      fs: 280,
      weight: 3,
  ...
  const air3c12 = await prisma.cargo.create({
    data: {
      name: 'ATGL (Serviced)',
      fs: 401,
      weight: 3620,
  ...
  const air3c13 = await prisma.cargo.create({
    data: {
      name: 'LPU-6P Infant Cot',
      fs: 280,
      weight: 4,
  ...
  const air3c14 = await prisma.cargo.create({
    data: {
      name: 'A/C Life Preserver',
      fs: -1,
      weight: 1.5,
  ...
  const air3c15 = await prisma.cargo.create({
    data: {
      name: 'Protective clothing kit',
      fs: 280,
      weight: 36,
  ...
  const air3c16 = await prisma.cargo.create({
    data: {
      name: 'BA-22 Parachute',
      fs: 280,
      weight: 28,
  ...
  const air3c17 = await prisma.cargo.create({
    data: {
      name: 'LPU-10P',
      fs: 280,
      weight: 4,
  ...
  const air3c18 = await prisma.cargo.create({
    data: {
      name: 'EPOS',
      fs: -1,
      weight: 2,
  ...
  const air3c19 = await prisma.cargo.create({
    data: {
      name: 'PBE',
      fs: 280,
      weight: 5,
  ...
  const air3c20 = await prisma.cargo.create({
    data: {
      name: 'Survival Vest',
      fs: 280,
      weight: 11.5,
  ...
  const air3c21 = await prisma.cargo.create({
    data: {
      name: 'Aircrew Body Armor (Level IIIA)',
      fs: 280,
      weight: 8.5,
  ...
  const air3c22 = await prisma.cargo.create({
    data: {
      name: '60 Hz Backup Converter',
      fs: 252,
      weight: 43,
  ...
  const air3c23 = await prisma.cargo.create({
    data: {
      name: 'Additional Aeromedical Stations',
      fs: -1,
      weight: 66,
  ...
  const air3c24 = await prisma.cargo.create({
    data: {
      name: 'Seat Pallets DV (5 Seats/Pallet)',
      fs: -1,
      weight: 591,
  ...
  const air3c25 = await prisma.cargo.create({
    data: {
      name: 'Seat Pallets DV (10 Seats/pallet)',
      fs: -1,
      weight: 767,
  ...
  const air3c26 = await prisma.cargo.create({
    data: {
      name: 'Seat Pallets Mass (15 Seats/pallet)',
      fs: -1,
      weight: 943,
  ...
  const air3c27 = await prisma.cargo.create({
    data: {
      name: 'Flares/Flare Cans (Note 1)',
      fs: 744,
      weight: 255,
  ...
  const air3c28 = await prisma.cargo.create({
    data: {
      name: 'Flare Hazard Placards (Note 1)',
      fs: 400,
      weight: 20,
  ...
  const air3c29 = await prisma.cargo.create({
    data: {
      name: 'Aircraft Armor (Note 1)',
      fs: 217,
      weight: 1125,
  ...
  const air3c30 = await prisma.cargo.create({
    data: {
      name: 'SLIP (unoccupied)',
      fs: -1,
      weight: 1350,
  ...
  const air3c31 = await prisma.cargo.create({
    data: {
      name: 'SLICC Berthing Capsule',
      fs: 580,
      weight: 3790,
  ...
  const air3c32 = await prisma.cargo.create({
    data: {
      name: 'SLICC Conference Capsule',
      fs: 685,
      weight: 4660,
  ...
  const air3c33 = await prisma.cargo.create({
    data: {
      name: 'MX TO File',
      fs: 305,
      weight: 30,
  ...
  const air3c34 = await prisma.cargo.create({
    data: {
      name: 'Kit, Passenger service',
      fs: 280,
      weight: 10,
  ...
  // create configs
  const air3config1 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'AE-1',
      configcargos: {
        create: [
          ...
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 69 } }, // water container
            fs: 358,
            qty: 3,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 70 } }, // std 2 gal liquid
            fs: 260,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 71 } }, // hot cup
            fs: 260,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 72 } }, // hw clean up kit
            fs: 280,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 73 } }, // blanket large
            fs: 280,
            qty: 6,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 74 } }, // pilllow lrg with case
            fs: 280,
            qty: 6,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 75 } }, // blanket small
            fs: 744,
            qty: 54,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 76 } }, // pillow small w case
            fs: 744,
            qty: 54,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 77 } }, // expendables
            fs: 260,
            qty: 1,
          },
          ...
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 85 } }, // lpu 10p
            fs: 280,
            qty: 2,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 81 } }, // lpu 6
            fs: 280,
            qty: 3,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 82 } }, // ac life pres
            fs: 744,
            qty: 110,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 83 } }, // pck
            fs: 280,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 86 } }, // epos
            fs: 744,
            qty: 102,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 87 } }, // pbe
            fs: 744,
            qty: 6,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 84 } }, // parachute
            fs: 280,
            qty: 2,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 89 } }, // bod armor
            fs: 280,
            qty: 5,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 88 } }, // survial vest
            fs: 280,
            qty: 5,
          },
          ...
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 101 } }, // to file
            fs: 305,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 97 } }, // acft armor
            fs: 217,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 95 } }, // flarees/ flare cans
            fs: 744,
            qty: 6,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 96 } }, // flare pacards
            fs: 400,
            qty: 4,
          },
        ],
  ...
  const air3config2 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'AE-2',
      configcargos: {
  ...
  const air3config3 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'AE-3',
      configcargos: {
        create: [
          ...
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 102 } }, // pass service
            fs: 280,
            qty: 1,
          },
          {
  ...
  const air3config4 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'AEC-1',
      configcargos: {
        create: [
          ...
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 72 } }, // hw clean up
            fs: 280,
            qty: 1,
          },
          {
  ...
  const air3config5 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'C-1',
      configcargos: {
  ...
  const air3config6 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'C-2',
      configcargos: {
  ...
  const air3config7 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'C-3',
      configcargos: {
  ...
  const air3config8 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'P-1',
      configcargos: {
  ...
  const air3config9 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'SP-X',
      configcargos: {
  ...
  const air3config10 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'CP-X',
      configcargos: {
  ...
  const air3config11 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'ADP-1',
      configcargos: {
  ...
  const air3config12 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'ADP-2',
      configcargos: {
  ...
  const air3config13 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'ADP-3',
      configcargos: {
  ...
  const air3config14 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'ADC-1',
      configcargos: {
  ...
  const air3config15 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'ADC-2',
      configcargos: {
  ...
  const air3config16 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'CDS-1',
      configcargos: {
  ...
  const air3config17 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'DV-1',
      configcargos: {
  ...
  const air3config18 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'SD-1',
      configcargos: {
  ...
  const air3config19 = await prisma.config.create({
    data: {
      aircraft: { connect: { id: 3 } },
      name: 'SLC-1',
      configcargos: {
        create: [
          ...
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 99 } }, // slicc berth
            fs: 401,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 100 } }, // slic confence
            fs: 401,
            qty: 1,
          },
          {
            aircraft: { connect: { id: 3 } },
            cargo: { connect: { cargoid: 98 } }, // slip
            fs: 401,
            qty: 1,
          },
  ...
  await prisma.general.create({
    data: {
      ...
      body:
        'User: Please be reminded that this app is intended for reference, and education purposes only. While careful consideration has been taken creating this app, we do not warrant, represent or guarantee that the material published on this app, as well as the calculations made, are in all respects accurate, complete or current. To the extent permitted by law, we exclude any liability, including any liability for negligence,  for loss, damage, or bodily injury arising from the reliance on material and calculations made in this application. It is your sole responsibility to make sure all proper measures are taken to ensure safety.',
  ...
  await prisma.general.create({
    data: {
      ...
      names: ['Help/Contact', 'About Developer'],
      body:
        'Admin: Please be reminded that this app is intended for reference, and education purposes only. While careful consideration has been taken creating this app, we do not warrant, represent or guarantee that the material published on this app, as well as the calculations made, are in all respects accurate, complete or current. To the extent permitted by law, we exclude any liability, including any liability for negligence,  for loss, damage, or bodily injury arising from the reliance on material and calculations made in this application. It is your sole responsibility to make sure all proper measures are taken to ensure safety.',
      icondatas: [59478, 57360], // flutter material icon data
      urls: [
        'https://forms.gle/Bbqvubn6gwC6fRnc8',
        'https://tsappdevelopment.github.io/hellohtml/',
  ...
  await prisma.general.create({
    data: {
      ...
      names: ['Help/Contact', 'About Developer'],
      body:
        'DB Admin: Please be reminded that this app is intended for reference, and education purposes only. While careful consideration has been taken creating this app, we do not warrant, represent or guarantee that the material published on this app, as well as the calculations made, are in all respects accurate, complete or current. To the extent permitted by law, we exclude any liability, including any liability for negligence,  for loss, damage, or bodily injury arising from the reliance on material and calculations made in this application. It is your sole responsibility to make sure all proper measures are taken to ensure safety.',
      icondatas: [59478, 57360], // flutter material icon data
      urls: [
        'https://forms.gle/Bbqvubn6gwC6fRnc8',
        'https://tsappdevelopment.github.io/hellohtml/',
